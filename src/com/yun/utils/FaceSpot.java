...
public class FaceSpot {
    ...
    //需要修改为自己的
    private static final String AppID = "21215550";
    private static final String APIKey = "747qMxwvbdGnBYA1p6yOROPX";
    private static final String SecretKey = "G5GZZxlInF0sibThdshcKS6ZWWuyRpmh";
    ...
    public static void main(String[] args) throws IOException {
        ...
        String file1 = "E:/1.jpg";
        String file2= "E:/4.jpg";
        String img2 = com.yun.utils.Base64Util.encode(FileToByte(new File(file2)));
        System.out.println(addUser(FileToByte(new File(file2)),"face","1","yun"));
    }
    //Base64参数
